                ...
                <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
                    <div class="text-center">
                        ...
                        <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                            ABS provides you and your team with the <span class="font-bold">MOST</span> comprehensive suite of <span class="font-bold text-indigo-500">(ERC-20 &amp; SEP-20)</span> token services including:
                            <span class="font-bold">minting, airdrops, payouts</span> and more..
                        </p>
                    </div>
                </div>
            </div>

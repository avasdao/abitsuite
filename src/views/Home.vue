                ...
                <div class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
                    <div class="text-center">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span class="block">Mint. Send. Drop. Burn</span>
                            <span class="block text-indigo-600">Your Tokens</span>
                        </h1>
                        <p class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                            ABS supports your team with the <span class="font-bold">MOST</span> comprehensive suite of <span class="font-bold text-indigo-500">(ERC-20 &amp; SEP-20)</span> token services, including:
                            <span class="font-bold">PoW Mining, Daily Payouts, Public Auctions</span> and more...
                        </p>
                    </div>
                </div>
            </div>

<template>
    <main class="py-16 xl:py-36 px-4 sm:px-6 lg:px-8 bg-white overflow-hidden">
                ...
                <div class="relative md:bg-white md:p-6">
                    <div class="lg:grid lg:grid-cols-2 lg:gap-6">
                        <div class="prose prose-indigo prose-lg text-gray-500 lg:max-w-none">
                            ...
                            <a href="https://www.printmag.com/featured/phases-of-the-web-design-process/" target="_blank" class="text-blue-500 text-sm no-underline hover:underline">
                                https://www.printmag.com/featured/phases-of-the-web-design-process/</a>

                            <ol role="list" class="ml-10">
                        ...
                        <div class="mt-6 prose prose-indigo prose-lg text-gray-500 lg:mt-0">
                            ...
                            <p>
                                Eu leo risus porta integer suspendisse sed sit ligula elit. Elit egestas lacinia sagittis pellentesque neque dignissim vulputate sodales. Diam sed mauris felis risus, ultricies mauris netus tincidunt. Mauris sit
                                eu ac tellus nibh non eget sed accumsan. Viverra ac sed venenatis pulvinar elit. Cras diam quis tincidunt lectus. Non mi vitae, scelerisque felis nisi, netus amet nisl.
                            </p>

                            <p>
                                Eu eu mauris bibendum scelerisque adipiscing et. Justo, elementum consectetur morbi eros, posuere ipsum tortor. Eget cursus massa sed velit feugiat sed ut. Faucibus eros mauris morbi aliquam nullam. Scelerisque
